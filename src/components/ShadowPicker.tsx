        ...
        <div class="component-shadow-picker">
          <div class="shadow-item">
            ...
            <div class="shadow-component">
              <color-picker value={values.value[3]} onChange={(v: string | number) => { updateValue(v, 3) }}></color-picker>
            </div>
          </div>
          <div class="shadow-item">
            <span>阴影大小:</span>
            <div class="shadow-component">
              <a-slider value={parseInt(values.value[0])} min={0} max={20}
                onChange={(v: string | number) => { updateValue(v, [0, 1]) }}></a-slider>
            </div>
          </div>
          <div class="shadow-item">
            <span>阴影模糊:</span>
            <div class="shadow-component">
              <a-slider value={parseInt(values.value[2])} min={0} max={20}
                onChange={(v: string | number) => { updateValue(v, 2) }}></a-slider>
            </div>
          </div>
        </div >
      </>
